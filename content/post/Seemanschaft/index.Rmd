...
>Germanische Lloyd für Yachten von 8-10 m Länge:  
Eine Handpumpe mit 5 und eine elektrische Pumpe mit 6 Kubikmetern Pumpleistung pro Minute
...
- Starkstromkontakte am Starter, Ankerwisch, Bugstrahlruder einmal jährlich säubern, fette und Dichtungen kontrollieren. 
...
- Gasflasche muss in Raum gestaut sein, der nur von oben zugänglich ist, zum Schiffsinneren dicht abgeschlossen und mit einer nach außen führenden Lüftung versehen ist.
...
- CO2-Löscher: Für enge Räume (Motorraum), muss nicht geziehlt auf Brandherd gerichtet werden, ist rückstandsfrei und ungiftig  
...
12. Die Bordapotheke sollte nach folgenden Richtlinien ausgesattet sein:  
- Fahrbereich  
...
>18. Eine moderne Automatik-Sicherungsweste funktioniert mit Hilfe einer wasserlöslichen Tablette. Diese blockiert einen federspannenden Bolzen. Bei Wasserkontakt (durch z. B. Eintauchen in Wasser) löst sich die Sperre innerhalb von Sekunden, und der Schlagbolzen schlägt die Öffnung in die keine Druckflasche. Aus der strömt dann das Kohlendioxid in die Schwimmkörper. Es gibt noch einen Nachblaseschlauch und eine Signalpfeife. 
Die Ohnmachtssicherheit wird durch die übergroßen Brustschwimmkörper im Gleichgewicht mit dem Nackenkissen gewährleistet.  

>Stichworte automatische Rettungsweste: CO2-Patrone, salzwasserlösliche Tablette, Auslösevorrichtung, manuelle Auslösevorrichtung, Mundaufblasvorrichtung, Gurte und Ringe, aufblasbarer Westenkörper, Signalpfeife, eventuell Nachtlicht mit
Salzwasserbatterie.
...
- Bei Schiffen über 12m sind die Lichter und Signalkörper manövrierunfähiger Fahrzeugen zu setzen (zwei schwarze Bälle oder zwei rote Rundumlichter)    
...
- Kurs und Geschwindigkeit zu einem gegebenenfalls vereinbarten Treffpunkt  
- Wetter im Seegebiet  
...
Gefahrenhalse: Man segelt einige Bootslängen weiter, um Höhe zu gewinnen. Ein Crewmitglied hat die Boje ständig unter Beobachtung. Nun fällt man ab, halst und luvt dann soweit an, dass ein Nahezuaufschießer gelingt. Bei diesem Manöver hat man einen Drehkreis gefahren. Die Boje hat man eben an Bbd. voraus. Durch Dichtholen der Segel kann jederzeit wieder kontrolliert Fahrt aufgenommen und reduziert werden. Nun Boje so ansteuern, dass man diese an Bb. bzw. an Stb. einholen kann. Evt. Schiff, wenn Boje querab an Bb. ist, Wende mit Beidrehen (Fock back, Großschot lose und Ruder nach Luv).  
...
Um nicht unnötig weit abzulaufen, wirft man sofort den Achterholer des Spi bzw. die Schot des ausgebaumten Vorsegels los, luvt unter dem auswehenden Spi oder Vorsegel an uns steuert direkt auf den Verunglückten zu. Der Motor ist zu starten und nötigenfalls zum Mitschieben einzusetzen. Spi oder Vorsegel lässt man während des ganzen Mövers fliegen. Es seid denn, es sind genügend Personen an Bord, die sich ausschließlich um das Bergen der Segel kümmern. Schlagende Segel sind in diesem Moment ein zusätzlicher Stressfaktor. Man vermeidet unter Motor aufzustoppen, um keinen Tampen in die Schraube zu bekommen. 
...
10. Mit einem Aufschießer der etwas kürzer angelegt ist, um bewusst etwas überzuschießen, kann man die Rettungsleine einsetzen => **eine Schiffslänge** vor Person Treibanker ins Wsser => **großer Halbbogen** um die Person => Beiliegen => Leine **von Bord aus holen** so dass Personen nur noch zugreifen muss. 
...
>Suchverfahren:   
Zunächst ist zu entscheiden, ob Streckensuche oder Raumsuche.  
- **Streckensuche** führt man durch, wenn die Person seit einer bestimmten Zeit vermisst ist. Man läuft den zurückliegenden Kurs mit exakter Navigation ohne Stromberücksichtigung (Selbststeueranlage benutzen!) zurück, bis über den Punkt hinaus, von dem an die Person vermisst ist. Man kehrt dann parallel um einen Suchstrefen versetzt zurück und legt Suchstreifen an Suchstreifen nach beiden Seiten ausweitend.   
- **Raumsuche** führt man durch, wenn während eines MOB der Sichtkontakt verloren gegangen ist. Man fährt mit paralellen Suchspuren ein angemessenes Quadrat von Bspw. 1 sm Kantenlänge ab, dessen Mittelpunkt der angenommene Ort bildet. Ist die Suche nicht erfolgreich, legt man weitere Suchstreifen spiralförmig ausweitend um das Quadrat.  
- Die **Breite der Suchstreifen** ist entscheidend. Bedenkt man, dass aus dem Cockpit einer Segelyacht (Augeshöhe 2 m) 1 m hohe Wellen in 40 m Abstand schon nicht mehr eingesehen werden können, sollte man die Suchstreifen mit Segelyachten entsprechend schmal wählen. 100 bis 200 m wären bei mittlerem Seegang das Maximum. 
...
>Nach ca. 2 SL verlässt die Bb.-Seite des Hecks die „alte“ Kurslinie. Es wird also zur Kollision des abdrehenden Hecks mit der Yacht kommen, wenn die Entfernung seit Abdrehen geringer ist. 
...
>Luvgierigkeit bei achterlicher See:   
...
>Alternativ: **Lenzen vor Topp und Takel**: Wenn die schwere See das Beidrehen, oder auch Beiliegen, nicht mehr als zweckmäßig erscheinen lässt, muss versucht werden, alle Segel zu bergen. Gesamtes Inventar zurren, um ein Verrutschen oder Übergehen zu verhindern. Versuchen, das Heck in die See zu drehen; gegebenenfalls mit Maschine. Dann von See und Wind treiben lassen. Das Steuern spielt hierbei die wichtigste Rolle. Um eine gewisse Steuerfähigkeit zu erreichen und die Driftgeschwindigkeit zu mindern, bringt man eine Leine aus, die auf beiden Seiten des Achterschiffes belegt und nachgeschleppt wird und somit im Wasser eine Bucht bildet. Die Leine kann beispielsweise zusätzlich mit Fendern beschwert werden, um die o.g. Bremswirkung zu erhöhen. Die Verwendung eines Treibankers verspricht dann Erfolg, wenn dieser so groß ist, dass sein Widerstand im Wasser größer ist als der des Bootes.  
Alternativ: „Abwettern“. (Beiliegen oder) das Schiff sich selbst überlassen heißt, ohne Segel, ohne nachgeschleppte Leine oder ohne Treibanker das Schiff sich selbst in eine „natürliche“ Schwimmrichtung zum Seegang und zum Sturm steuerlos einschwingen zu lassen. Yacht driftet mehr oder weniger in Querlage. Die Mannschaft hat dabei nur ständig auf die Einrichtungen zu achten.  
**Das Gelingen der beschriebenen Maßnahmen hängt erheblich vom Schiffstyp ab.**
...
- bei Bruch der Ankerleine ist die Bergung des Ankers möglich. beim Festkommen an einem Unterwasserhindernis kann der Anker durch Ziehen entgegen
der Zugrichtung der Ankerkette gelichtet werden.
...
Schiff wird bei zu großer Dimensionierung des Treibankers stark „festgehalten“, Schäden durch **Seeschlag** auf Bug oder Heck (ins Cockpit), Ruderbruch und Ausreißen der Decksbeschläge können die Folge sein.