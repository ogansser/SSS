...
slug: []
categories: []
tags: [Segelfahrzeug, Stabilität, Sicherheitsausrüstung - Handhabung, Seetücjtigkeit, Verhalten in Notfällen, Kollision, Seenotfall, Mensch über Bord, Maßnahmen bei Verletzungen und Unterkühlung, Manövrierverhalten von Seeschiffen, Fahren in schwerem Wetter, Ankern]
summary: Segelfahrzeug, Stabilität, Sicherheitsausrüstung - Handhabung, Seetücjtigkeit, Verhalten in Notfällen, Kollision, Seenotfall, Mensch über Bord, Maßnahmen bei Verletzungen und Unterkühlung, Manövrierverhalten von Seeschiffen, Fahren in schwerem Wetter, Ankern
output:
  blogdown::html_page:
    toc: TRUE
...
![](https://vg08.met.vgwort.de/na/26158e5c6a5f4472a81c23ae5c5578b2
...
3. Das 7/8- oder das 3/4-Rigg einer **Slup** ermöglicht es, mit dem Achterstag den Mast so zu biegen, dass der Großsegelbaauch nach vorn herausgeszogen und das Segel flach getrimmt wird. 

4. Bei einer **Yawl** (zusätzulich kleines Segel achtern) steht der Besanmast so weit achtern, damit er einen Hebelarm bildet => Trimmwirkung leichter => Gierigkeit wegtrimmen.
...
Nach dem Starten kontrolle von:
...
- Öldruck fällt: Motor unverzüglich abstellen  
  ...
  Wenn Ölstand gering => Öl nachfüllen => Motor wieder starten => Ursache für Ölverlust klären => Sichtkontrolle gemater Motor, Ölkühler, Verbindungsschläuche, Motorbilge
...
15. Wenn eine Yacht bei Seitenwind aufgestoppt wird driftet der Bug nach Lee weg => Yacht in den Wind stellen undunter Motor im Wind halten

16. Als schleppendes Fahrzeug wird die eigene Steuerfähigkeit sichergestellt in dem mit einem Stoppersteck ein zweites Tau  an der Schlepptrosse angeschlagen wird. Beide Tau werden durch die achterne Lippklampe auf die jeweilige Genuawinsch geführt. 
...
20. Bei der Übernahme einer Charteryacht muss an in Erfahrung bringen ob es sich bei der elektrischen Anlage um eine manuelle (zwei gleichwertige Batterien getrennt und zusammen schaltbar => getrennt entladen und zusammen laden) oder um eine automatische (Start- und Versorgungsbatterie getrennt, mit Versurgungsbatterie kann auch im Notfall gestartet werden => Hauptschalter umlegen) handelt.   
...
26. **Flüssiggasanlagen** an BOrd können gefährlich sein. Ausströmendes Gas sammelt sich im Schiff und kann, weil es schwerer als Luft ist, nicht von selbst entweichen. Mi Luft vermischt ist es schon in geringen Mengen explosiv. Außerdem besteht Erstickungsgefahr weil Gas fast doppelt so schwer wie Atemluft. 

27. Bei ausströmendem Gas sollte man eingeschaltete elektrische Anlagen nicht ausschalten, weil auch beim Ausschlaten elektrische Schaltfunkten enstehen können. 

28. Eine Gasanlage wird gemäß DVGW (Deutsche Vereinigung des Gas- und Wasserfachs) nach folgenden Grundsätzen installiert: 

- Gasflasche muss in Raum gestaut sein, der nur von oben zugängich ist, zum Schiffsinneren dicht abgeschlossen ud mit einer nach außen führenden Lüftung versehen ist.

- Flasche wird übereine Normanschluss mit verstellbarem Druckregler (50 mbar Ausgangsdruck), Sicherheitsvertnil (100 bis 120 mbar Ablassdruck) und Absperrhahn angeschlossen. 
...
Krängungsmoment < aufrichtende Moment => Abnhame der Neigung bis zum stabilen Krängungswinkel
...
4. **Yachtstellung** bedeutet, dass zwei Reflexionstrichter voraus und zwei achtern zu richten sind, weil Segelyacht von vorn und von achtern am wenigsten reflektiert wird. 
...
- Die Pumpen sauen am Lenzbrunnen, dem tiefsten Punkt in der Bilg
...
- medizinische Vorbildung unter der Besetzung  
...
18. Eine moderne Automatik-Sicherungsweste funktioniert mit hilfe einer wasserlöslichen Tablette. Diese blockiert einen federspannenden Bolzen. Bei Wasserkontakt (durch z. B. Eintauchen in Wasser) löst sich die Sperre innerhlab von Sekunden, und der Schlagbolzen schlägt die Öffnung in die keine Druckflasche. Aus der strömt dann das Kohlendioxis in die Schwimmkörper. Es gibt noch eeinen Nachblaseschlauch und einen Signalpfeife. 
...
- Im Cockpit: Augenbolzen in außreicheder Anzahl im Cockpit
...
23. Am Ende der Wurfleine sollte der zweite Rettungskragen und ein Kiessäckchen als Wurfgewicht befestigt sein. Man wirft den so beschwerten Rettungskragen mit freiem Schwung, die Leine wird imFlug ausgezogen. 
...
- Logbuch, Schiffspapiere (nicht teil des ORC-Katalogs)
...
1. Beim Erwerb einer Yacht kann deren Tauglichkeit durch eine **CE-Kennzeichnung** bescheinigt werden. Danach müssen Hersteller nach einen vorgeschriebenen Prüfverfahren nachweisen, für welche Belastung ein Fahrzeug Sicherheit gewährt.  
...
6. Unter geeigneten Mitgliedern einer Besatzung sind solche zu verstahen, die unter dern knappen Anleitung mit den üblichen Kommandos ihren Part beim Manöver selbständig übernehmen können.
...
9. Bei den veranschlagten **Etmalen** ist von eienr vernünftigen Durchschnittssegelleistung auszugehen, einschließlich der Großwetterlage angemessenen Sicherheitsabzugs für Schwachwindzonen und für Kreuzstrecken. Aufgrund des Motors auf eine höhere Streckenleistung zu setzen, gilt zunächst nur im Falle von zu schwachem Wind. 

10. DasStauproblem bekommt man am besten in den Griff mit einer durchdachten **Stauordnung** bezgl. Geeicht, Verderblichkeit und Wiederfinden. => Besonderer Bereich für angebrochene Gebinde => Verantwortung durch einen Mitsegler.
...
Die meisten Yachten lass sich vom Amwind- bis Halbwindkurs völlig ohne Ruder nur **durch die Segelsteuerung steuern** => Vorsegel auf optimalen Vortrieb trimmen => steuern mit Großsegel oder Besan 
...
- Verletzungsgefahr bei Bruch der Schlepptrosse bachten  
...
12. Gebrochenes Stahdrahttauwerk (Wanten oder Stagen) repariert man oder ersetzt sie durch Fallen. Verbindungen werden mit Augen hergestellt, die am mit Drahtseilklemmen steckt. 
...
16. Bei einer Grundberührung versuch man das **Festkommen zu zuverhindern** durch schnelle Reaktion => Hart Ruder in die Richtung wo man das tiefere Wasser vermutet (oder hart abfallen) => Motor starten und Segel dichtholen => Schiff kränkt und Kiel wird angehoben. 
...
- hindernissfreie Stelle am Strand **mit ungehmmter Fahrt** anlaufen  
- **hoch aufgleiten**, dass die Yacht möglichst fest liegen bleibt und nicht angehoben und quergedreht werden kann. 

# Kollision 

1. Von der **Beistandspflicht** kann abgesehen werden, wenn durch die Hilfsmmaßnahmen das eigene Schiff und die Besatzung in unvertretbarem Maße gefährdet würden. Es gilt das Prinzip der Angemessenheit. 

2. Maßnahmen zur Sicherung der Unfallstelle in verkehrsreichem Gebiet: 

- Die Schiffahrt über Funk mit wiederholtenSicherheitsmeldungen vor dem Schiffshinderniss warnen  
- Über die Küstenfunkstele oder den Revierfunkdienst ist das zuständige Wasser- und Schiffahrtsamt zu informieren  
...
4. Die beiden Schiffsführer tauschen für stätere Regelung der Haftung folgende Informationen aus: 

- Schifsname und Unterscheidungssignal  
- Heimathafen  
- Bestimmungshafen  
...
1. Seenotfall unterscheidet sich vom Notfall im Betrieb einer Yacht der Seenotfall eine besondere Situation ist, **in der eine echte Gefahr für Schiff oder Besatzung besteht und fremde Hilfe zur Abwendung dieser Gefahr erforderlich ist**
...
- Mit Handsprechfunkgerät von Zeit zu Zeit **Notrfequenz abhören**. Nur senden, wenn Schiff in Sicht, wegen Sendeleistung  
...
- Zusammenbleiben, Körperkontakt mit anderen halten, um den Wärmestrom zuverringern  
- Atmungsöffnungen vor Spritzwasser schützen  
- NAchts oder bei schlechter Sicht sich mit Signalpfeife bemerkbar machen undum ein schwimmfähiges Rettungslicht sammeln  
...
13. Hauptgefahr beim Abbergen von Personen durch ein Frachtschiff liegt im **schlagendem Mast** => Abstand halten

14. Frachtschiffe können bei schwerer See Hilfe leisten indem sie sich in Luv quer vor den Havaristen legen. Mit Funk des GMDSS kan weitere Hilfe angefordert werden (z. B. Hubschrauber). 
...
16. Die Rettungsschlinge wird mit dem Verschluss nach vorne über den Kopf und Arme gestülpt, sodass die **unter den Achseln** trägt. Es ist unbedingt darauf zuachten, dass das Kabel direkt ins Wasser hängt und nicht irgendwo **hinterhakt**. Auf Zeichen "Daumen nach oben" taut der Hubschrauber an und zieht die Person in der Schlinge **schräg seitlich vom Achterstag weg** nach oben. Nicht schaugeln und darauf achten, dass das Kabel sich nicht um das Achterstag schlingt.


# Mensch über Bordn (MOB)
...
- Vom Sichtkontakt und dem Manövver abgelenkt wird  
- Markierung der Stelle wegen nicht hohem Seegang notwenig  
- Über Bord gefallene Person trägt einen Rettungsweste
...
2. Der Schiffsführer einer Yacht muss als medizinischen Hilfsmittel über mindestens eine auf das Fahrtgebiet, Anzahl, Dauer der Reise, Alter und gesundheitlichen Zustand der Besatzung abgestimmte **Bordapotheke** und Anwendungsanweisung verfügen.
...
Exkurs: 
Um mit einer Hochseeyacht schweres Wetter abzuwettern, gibt es nach allgemeinen seemännischen Erfahrungen mehrere Möglichkeiten. Wichtige Verhaltensregeln für die Seewache bei Sturm sind unter anderem: Wetterkleidung, Sicherheitsgurt immer eingepickt, Rettungsweste Niedergang und Luken dicht kein unnötiger Aufenthalt außerhalb des Cockpits Verschärfter Ausguck nach Luv, Zurufdistanz des Ausgucks zum Rudergänger Backskistendeckel verriegelt Rudergänger gesichert und mit gutem Halt sitzend Einigkeit über die anzuwendende Sturmtaktik Rechtzeitiges Abwechseln am Ruder
...
15. Kotrolle der Fahrt bei Halbwind oder Amwindkursen in schwerem Seegang:
