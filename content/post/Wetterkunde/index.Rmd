...
slug: []
categories: []
tags: [Grundlagen Wetterkunde, Wolken und Nebel, Druckgebilde, Regionale Wettererscheinungen, Wetterregeln, Seegang, Seewetter-Informationen, Verarbeitung vonSeewetterberichten, Meteorologische Geräte]
summary: Grundlagen Wetterkunde, Wolken und Nebel, Druckgebilde, Regionale Wettererscheinungen, Wetterregeln, Seegang, Seewetter-Informationen, Verarbeitung vonSeewetterberichten, Meteorologische Geräte
output:
  blogdown::html_page:
    toc: TRUE
...
- **Sättigungsfeuchte A** = maximal mögliche Wasserdanpfmenge bei einer bestimmten Temperatur. 
...
- in dem Feuchte zugeführt wird (Feuchtezufuhr)
- in dem die Temperatur gesenkt wird (Abkühlung)
...
|Winter|- klirrender Frost bei strahlend blauem Himmel, aus trockener Kaltluft aufgebauten Hochs<br>- Vom Meer her kommende feuchte Luft => bodennahe zuNebel neigende feuchte, diesige Schicht, Oberhalb wolkenlos und klar = Inversion => Hochnebel mit manchmal Sprühnebel oder Schnee|
|Übergangszeit|Sonnneneinstrahlung löst winterlicher nächstlicher Charakter auf => sommerliches Hochdruckwetter|
...
- junges Ideales Tief   
- okkludierendes Tief 
- Auflösung oder Weiterentwicklung zueiner Zentralzyklone (rießiges Tief)  
...
In Hochdruckgebieten steigt die Luft ab. Aus dem Hoch (Antizyklone) weht der Wind auf der Nordhalbkugel im Uhrzeigersinn (antizyklonal) heraus (22 Grad von den Isobaren vom Hoch weg).
...
Dieser Wind ist an eine großräumige Druckverteilung gebunden: hoher Druck über Südeuropa, der bis zur Ägäis reicht, und tierer Druck über Kleinasien und dem östlichen Mittelmeer. 
...
## Regeln über die Bewegung von Fronten 14. Kaltfronten ziehen schneller als Warmfronten, manchmal doppelt so schnell
...
23. Gleichbleibender Luftdruck deutet auf beständiges Wetter hin 
