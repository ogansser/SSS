...
>6. **Isobaren** sind **Linien, die die Orte gleichen Luftdrucks miteinander verbinden**. In den Wetterkarten sind Isobaren im Abstand von **5 hPa** gezeichnet (In England **4 mbar**) 
...
>Gradient ist der **Luftdruckunterschied** in hPa bezogen auf eine Strecke von **60 sm** senkrecht zu den Isobaren. Er ist umso größer, je dichter die Isobaren liegen. 
...
>Die Schwankung in der Windrichtung kann bis zu 45 Grad um die Hauptwindrichtung betragen, also bei Formulierung "Nordwest" von Westnordwest (WNW) bis Nordnordwest (NNW). Es können Böen auftreten, die etwa 1 bis 2 Bft über dem Mittelwind liegen.
...
40 kn = 8 Bft  
50 kn = 10 Bft  
60 kn (1 Dreieck + 1 ganze Fieder) = 12 - 1 = 11 Bft   
...
- **Stratus oder Stratocumulus**: Wind und die allgemeine Rauhigkeit der Landschaft lassen Luft bis zum Kondensationsniveau aufwirbeln (Turbulenzwolken). Es können dabei Schicht oder Schichthaufenwolken enstehen
- **Wogenwolken**: Die Luft steigt wellenförmig in das Kondensationsniveau hinein und wieder heraus. Häufig in Lee von Gebirgen.


>Zu den **Konvektionswolken** gehören zum Beispiel Cumulus und Cumulonimbus Wolken. Cumuluswolken haben eine flache, abgerundete Basis und eine kuppelförmige Oberseite. Sie sind oft weiß und können einzeln oder in Gruppen auftreten. Cumulonimbuswolken sind die Wolken, die mit Gewittern assoziiert werden. Sie sind deutlich größer als Cumuluswolken und haben eine hohe, eindrucksvolle Kuppel. In der Regel haben sie eine dunkle Basis, die mit Regen, Hagel oder sogar Blitzen verbunden sein kann.
...
>**Altocumulus castellanus** (mittelhohe türmchenartige Haufenwolken) kündigen oft schon vormittags kräftige Wärmegewitter an.

>**Haufenwolken (Cumulus)** zeigen sich am späten Vormittag über Land am Himmel und kündigt Seewind an.
...
>**Gefahr für die Sportschiffahrt**:  
...
> In Seewetterbericht bei **Gefahr von Gewittern** werden die erwarteten Böen explizit mit
angegeben: Die Böen weichen in der Windstärke insbesondere bei schweren Gewittern oft um ein **Vielfaches vom Mittelwind ab, manchmal** erreichen sie **Orkanstärke**. 
...
- Ist die Wolkendecke geschlossen (Stratus) ist die Böigkeit gering   
- Ist die Bewölkung aufgelockert (Cumulus), dann ist die Böhigkeit erhöht   
...
- Kaltfront Typ A (**aktive Kaltfront**): Kaltluft stößt heftig gegen Warmluft. Es enstehen Altocumulus  
...
>**Enstehung einer Okklusion**: Durch die **höhere Verlagerungsgeschwindigkeit** holt die Kaltfront die Warmfront ein und hebt die Warmluft vom Boden ab. Ist die Luft vor der Front kälter als hinter der Front, so nimmt diese Warmluftcharakter an (**Warmfrontokklusion**), im anderen Fall Kaltfrontcharakter (**Kaltfrontokklusion**).
...
- Warme Luft streicht im Frühjahr über kaltes/kälteres Wasser (z.B. in der Ostsee). Die warme Luft kühlt an der kalten Meeresoberfläche soweit ab bis Kondensation eintritt (= **Kaltwassernebel**).    
- Kalte Luft streicht über wärmeres Wasser (z.B. im Herbst im Bereich der Ostsee = Herbstnebel). Das wärmere Wasser gibt laufend Feuchtigkeit an die Luft ab, es entsteht Nebel durch Verdunstung (= **Warmwassernebel**).   
...
>Strahlungsnebel sind oft nur wenige Meter dick und können sehr dicht sein, was zu einer erheblichen Sichtbehinderung führen kann. Das kann insbesondere für die Sportschifffahrt **gefährlich sein**, da es die Navigation erschwert und das Risiko von Kollisionen erhöht. Daher ist es wichtig, dass Sportbootfahrer in der Nähe von Flüssen, Seen und anderen Gewässern auf die Bildung von Strahlungsnebel achten und ihre Geschwindigkeit reduzieren, um mögliche Gefahren zu minimieren.
...
Nördlich von einer vorbeiziehender Zyklone ist der Wetterverlauf gleichmäßiger als im Süden. Es gibt  
- keine Fronten   
...
11. An Hoch- und Tiefdruckgebieten befinden sich **gekrümmte Isobaren** Ein Luftteilchen, das solch eine Krümmung durchläuft, unterliegt der Fliehkraft, die die Winstärke ändert: An Tiefdruckgebieten ist bei gleichem Isobarenabstand die Windgeschwindigkeit geringer als bei parallelen Isobaren, an Hochdruckgebieten ist sie größer. 

12. **Wetterverlauf** einer vorüberziehenden Zyklone, wenn Beobachter sich südlich befindet:
...
- Beim passieren der Front  
  ...
  - Temperatur sinkt
  - Sicht verbessert sich, Rückseitenwetter

>Sicht- und Wetterverhältnisse typischerweise   
- **vor oder nahe der Warmfront**: Sichtverschlechterung durch Niederschlag, Himmel bedeckt, länger andauernder Regen   
...
>Zugbahnen:   
- **Randtief:** Zieht auf **zyklonaler Bahn** (auf der Nordhalbkugel entgegen dem Uhrzeigersinn) **polwärts um das Haupttief herum** (wird also quasi von diesem gesteuert). Je **stärker** sich das Randtief **vertieft**, umso **größer** ist die **Tendenz polwärts einzudrehen**.   
...
# Regionale Wettererscheinungen
 ...
 > Landwind und Seewind: Bei intensiver Sonneneinstrahlung in unmittelbarer Küstennähe. Verstärktes auftreten bei trockenen Küsten, , da sich dann das Land schneller erwärmt bzw. abkühlt. 
...
- Ablandiger Wind: Weht der Wind ablandig, muss örtlich mit umlaufenden Winden und erhöhter Böigkeit (Fallwinden) gerechnet werden.
...
- Mistral verstärkt durch ein Tief mit Fronten, dessen Rückseite Luft aus Südfrankreich ansaugt.  
...
- Klassische Ausgangslage: Kräftiges **Tief über der Ostsee** (Nord- und Osteuropa), das nach Russland zieht, und **Hoch über dem Ostatlantik/Biskaya**.  
...
5. **Boraartige und föhnartige Fallwinde** sind die an der kroatischen und albanischen Küste auftretenden kalten Fallwinde.
...
- **antizyklonale Bora**: Bora ensteht an der südlichen Flanke eines umfangreichen Hochs oder Hochkeils. 
...
>**Seegangshöhen** in Europa werden in der Regel in Wetterberichten in Meter (m) angegeben. Die Seegangshöhe bezieht sich auf die **durchschnittliche Höhe der höchsten Drittel der Wellen und wird oft als signifikante (kennzeichnende) Wellenhöhe** bezeichnet. Es ist jedoch wichtig zu beachten, dass die tatsächlichen Bedingungen auf See von vielen Faktoren abhängen, wie z.B. **Windgeschwindigkeit, Wassertiefe und Strömungen**, und dass es immer ratsam ist, spezifische Informationen von lokalen Wetterdiensten oder Behörden einzuholen, bevor man auf See geht.

> **Wellenhöhe 4m** bedeutet:   
- Die **kennzeichnende Wellenhöhe** (das **Mittel aus dem oberen Drittel der Wellenhöhen**) beträgt 4m.     
- Die tatsächliche Wellenhöhe kann häufiger den 1,5 fachen Wert = 6m ereichen, vereinzelt auch höher.  
...
>Seegang besteht aus Windsee und Dünung.
...
>Kreuzseen enstehen, wenn sich **Wellen aus unterschiedlichen Richtungen überlagern**. Dabei besteht die Möglichkeit, dass sich die maximale Wellenhöhe von jedem Wellensystem addiert zu einer entsprechend hohen Welle.   
**Ferner werden die Wellen sehr steil**, so dass sie sichbrechen können. Im Extremfall ist keine Verlagerungsrichtung mehr erkennbar. 
>Wellen miut unterschiedlichen Laufrichtungen können durch folgende Überlagerungen auftreten:   
- von Windsee und einer (von fern kommenden) Dünung  
- von Windsee und Dünung vor Kaltfronten, Okklusionen oder Trogachsen  
- von sich drehenden Wellen in Leeeiner Bank oder Insel
...
>Man spricht allgemein von einer Grundsee, wenn eine Welle aufgrund ihrer Länge auf flachem Wasser vom Meeresboden aufgesteilt wird. Es kommt zum Überbrechen hoher bzw. steiler Wellen.
...
|-----------|----------|-------|
|Bundesamt für Seeschiffahrt und Hydrographie (BSH)|Europäische Gewässer|**Stationen, Vorhersagegebiete und Frequenzen**|
...
- Revierzentralen
- Internet
- SEEWIS-online, SEEWIS-Fax (Seewis = Seewetterinformationssystem des DWD)
...
>**Starkwindwarnung** (near gale warning) über **NAVTEX**: Zeitliche Abstand vom Erhalt der Warnung bis zum Eintreffen des
Ereignisses:  I.d.R. 6-8h, in Einzelfällen auch kürzer
...
- Regeln: 
  - Isobaren im Abstand 5 zu 5 hPa (in England 4 zu 4 hPa)
...
=> Isobaren so zeichnen, dass auf See ein Winkel von 22 Grad (über Land mehr) zwischen ihnen und der Windrichtung entsteht. **Fähnchen zeigen auf der Nordhalbkugel immer zur linken Seite**. => tiefe Druck liegt, in Windrichtung geschaut, links.
...
- **Amtlich**:   
   ...
   - angelsächsische Veröffentlichung „Admiralty List of Radio Signals Volume 3“.    
...
>Beispielangabe in Wetterbericht **Nordwest um 6** bedeutet:   
- WNW bis NNW (also iim Bereich von höchstens 45 Grad)   
- Bei Wind aus dem NW-Sektor mann man etwa einen Zuschlag von 2 Bft an Böen erwarten. NW um 6 heißt **Böen bis mindestens 8 Bft**
